  ...
  const handleSaveSetting = async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        toastSuccess(
          "Pengaturan disimpan",
          "Jadwal pengingat berhasil diperbarui.",
        );
      } else {
        toastError(
          "Gagal menyimpan",
      ...
      <div className="max-w-4xl mx-auto space-y-8 pb-20">
        ...
        <AnimatePresence>
          {showSettings && (
            <motion.div
              ...
              exit={{ opacity: 0, y: -8 }}
              className="bg-white border border-zinc-200 rounded-4xl p-6 shadow-sm space-y-5"
            >
        ...
        <div className="space-y-3">
          {loadingLogs ? (
            ...
            <div className="text-center py-16 bg-white border border-dashed border-zinc-200 rounded-4xl">
