  ...
  return (
    <div className="relative min-h-screen w-full flex items-center justify-center p-6 md:p-12 overflow-hidden bg-[#FBFBFA]">
      ...
      <motion.div 
        ...
        className="relative z-20 w-full max-w-[520px] bg-white/80 border border-stone-200/90 rounded-[2.5rem] p-8 md:p-10 shadow-[0_25px_50px_rgba(28,22,20,0.04),inset_0_1px_2px_rgba(255,255,255,0.8)] backdrop-blur-xl group/card flex flex-col gap-8"
      >
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <h2 className="text-xl font-extrabold text-[#1C1614] tracking-tight">Masuk Kembali</h2>
          <p className="text-[10px] font-bold text-stone-400 mt-1 uppercase tracking-wider font-sans">Nikmati Pengalaman Dapur Hijau Pintar</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5 relative z-10">
          ...
          <div className="space-y-1.5">
            <label htmlFor="email" className="text-[10px] font-extrabold uppercase tracking-wider text-stone-500 ml-1">Alamat Email</label>
          ...
          <div className="space-y-1.5">
            <div className="flex justify-between items-center px-1">
              <label htmlFor="password" className="text-[10px] font-extrabold uppercase tracking-wider text-stone-500">Kata Sandi</label>
              {/* SIZE="SM" SUDAH DIHAPUS DI SINI AGAR TIDAK ERROR */}
              <Link href="/forgot-password" className="text-[10px] font-bold text-amber-600 hover:underline">
                Lupa Sandi?
              </Link>
            </div>
            <div className="relative">
          ...
          <motion.button
            ...
            type="submit"
            disabled={loading}
            className="w-full bg-[#1C1614] text-white font-extrabold py-4 rounded-xl flex items-center justify-center gap-3 transition-all mt-4 shadow-[0_12px_24px_rgba(28,22,20,0.12)] group/btn text-xs uppercase tracking-wider"
          >
            {loading ? (
        ...
        <p className="text-center text-stone-400 text-xs font-medium">
          Belum memiliki akun?{" "}
          <Link href="/register" className="text-[#1C1614] font-bold hover:underline">
            Daftar di sini
          </Link>
        </p>
      </motion.div>

      {/* ─── PEMBATAS GELOMBANG BAWAH ─── */}
